...
from ..configs.bflylr_fnet_config import BflyLR_FNetConfig
...
_CONFIG_FOR_DOC = "BflyLR_FNetConfig"
...
class BflyLR_BertIntermediate(nn.Module):
...
class BflyLR_BertOutput(nn.Module):
    def __init__(self, config):
        super().__init__()
...
class BflyLR_BertLayer(nn.Module):
    def __init__(self, config):
        super().__init__()
        ...
        self.intermediate = BflyLR_BertIntermediate(config)
        self.output = BflyLR_BertOutput(config)
    ...
    def __init__(self, config):
        ...
        for i in range(config.num_hidden_layers):
            if self._is_attention_layer(i):
                layer_list.append(BflyLR_BertLayer(config))
            else:
...
class BflyLR_FNetPreTrainedModel(PreTrainedModel):
    """
    An abstract class to handle weights initialization and a simple interface for downloading and loading pretrained
    models.
    """

    config_class = BflyLR_FNetConfig
    ...
    def _init_weights(self, module):
        ...
        '''
        if isinstance(module, ButterflyLRLinear):
...
FNET_START_DOCSTRING = r"""
    ...
    behavior.
    Parameters:
        config ([`BflyLR_FNetConfig`]): Model configuration class with all the parameters of the model.
...
class BflyLR_FNetModel(BflyLR_FNetPreTrainedModel):
    """
    ...
    def forward(
        ...
        if (
            ...
            raise ValueError(
                "The `tpu_short_seq_length` in BflyLR_FNetConfig should be set equal to the sequence length being passed to the model when using TPU optimizations."
            )
...
class BflyLR_FNetForPreTraining(BflyLR_FNetPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

        self.fnet = BflyLR_FNetModel(config)
...
class BflyLR_FNetForMaskedLM(BflyLR_FNetPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class BflyLR_FNetForNextSentencePrediction(BflyLR_FNetPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class BflyLR_FNetForSequenceClassification(BflyLR_FNetPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class BflyLR_FNetForMultipleChoice(BflyLR_FNetPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class BflyLR_FNetForTokenClassification(BflyLR_FNetPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
...
class BflyLR_FNetForQuestionAnswering(BflyLR_FNetPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
