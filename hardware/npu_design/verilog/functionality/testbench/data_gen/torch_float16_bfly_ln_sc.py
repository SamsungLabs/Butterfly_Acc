...
def gen_bfly_ln_sc_float16(args):
    n = 256 # bfly_length
    ...
    # Run butterfly
    print ("========Running Butterfly with LN and SC=======")
    ...
    np.savetxt(path+'/output_bfly.txt', np_output.astype(np.float16), delimiter='\n', fmt='%s')
    # Get LN output
